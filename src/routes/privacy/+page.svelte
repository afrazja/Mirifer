<svelte:head>
	<title>Privacy Policy | Mirifer – Learn German Online</title>
	<meta name="description" content="Mirifer privacy policy. Learn how we handle your data, what we collect, and how we protect your information." />
...
<main class="legal-page">
	...
	<article class="legal-content">
		...
		<h2>2. Voice Data</h2>
		<p>Voice answers use your browser's speech recognition. Your browser may send audio to its speech recognition service (for example, Google in Chrome). The recognized words appear in the answer box for you to review before sending. Optional practice clips stay in this tab for replay and are never uploaded or graded. The receptionist's lines are turned into speech by our server with OpenAI's voice service, falling back to a Microsoft voice service and then your browser's own voice. Only the receptionist's lines and the suggested model sentences are sent for speech, never anything you say or type.</p>
		<p>The English Listen &amp; retell exercise is the one place where your voice leaves your device. Pieces are read aloud by OpenAI's voice service. When you ask for feedback, your recording passes through our server to OpenAI's speech-to-text service to turn it into text, and is then discarded: Mirifer never stores the recording or the transcript. The transcript and the piece go to Google Gemini, DeepSeek, or OpenAI for feedback, as described below. We keep only your best score per piece (how many key points you covered, and whether you used the text). Everywhere else, Mirifer does not receive or store your voice audio.</p>

		<h2>3. How We Use Your Data</h2>
		<p>Some conversation practice uses AI. In the English hotel lesson, the receptionist is played by AI: each reply you send (typed, or approved from speech recognition), together with the conversation so far and the lesson's scenario, goes to Google Gemini, DeepSeek, or OpenAI, in that order when available. The provider writes the receptionist's next line, notes which lesson goals you have reached, and may suggest a short language correction. When you finish, the conversation is sent once more so the provider can suggest more natural ways to say some of your sentences. German free conversation sends the text of your exchange and lesson context to an AI provider. These providers process the text under their own policies; DeepSeek may process data in China. We do not send your account identifier in those AI requests, and voice recordings go only to OpenAI's speech-to-text service in Listen &amp; retell. If no provider responds, your reply stays in the answer box so you can try again.</p>
		<ul>
			<li>To provide and improve the learning experience</li>
			<li>To track your lesson progress and spaced repetition schedule</li>
			<li>To sync your data across devices when signed in</li>
		</ul>
		...
		<h2>6. Your Rights</h2>
		<p>You can request deletion of your account and all associated data at any time by contacting us. We will process deletion requests within 30 days.</p>

		<h2>7. Cookies</h2>
		<p>Mirifer uses essential cookies for authentication (keeping you signed in). Analytics tools may set their own cookies for anonymous usage tracking.</p>
