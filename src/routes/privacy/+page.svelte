...
<main class="legal-page">
	...
	<article class="legal-content">
		...
		<p>Some conversation practice uses AI. In the English hotel lesson, we normally send each reply you type or approve from speech recognition, together with the current lesson step, to Google Gemini, DeepSeek, or OpenAI, in that order when available. The provider checks whether your reply fits the conversation and may suggest a short language correction. Empty, oversized, and certain clearly conflicting replies are handled without AI. German free conversation also sends the text of your exchange and lesson context to an AI provider. These providers process the text under their own policies; DeepSeek may process data in China. We do not send your account identifier or voice recording in those AI requests. Prepared examples remain available if the AI checker cannot respond.</p>
		<ul>
